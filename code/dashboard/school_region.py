...
# geojson파일 불러오기
file_path = '../../data/지도 시각화 데이터\/L_SCCO_CTPRVN.json'
...
# 학교별 데이터 불러오기 - 시도별
school2019 = pd.ExcelFile('../../data/학교,학과별 데이터셋/2019년_상반기_시도별.xlsx')
school2020 = pd.ExcelFile('../../data/학교,학과별 데이터셋/2020년_상반기_시도별.xlsx')
school2021 = pd.ExcelFile('../../data/학교,학과별 데이터셋/2021년_상반기_시도별.xlsx')
school2022 = pd.ExcelFile('../../data/학교,학과별 데이터셋/2022년_상반기_시도별.xlsx')
school2023 = pd.ExcelFile('../../data/학교,학과별 데이터셋/2023년_상반기_시도별.xlsx')
